...
var pluraliaMessages = []goai.Message{}
...
var rootCmd = &cobra.Command{
	Use:   "pluralia",
	Short: "pluralia OpenAI Chat Bot " + APP_VERSION,
	Long: `
	pluralia
	GitHub: https://github.com/seemywingz/pluralia
	App Version: ` + APP_VERSION + `

  pluralia uses OpenAI's API to generate text responses to user input.
...
func viperConfig() {
	...
	viper.SetDefault("openAI_image_downloadPath", "~/pluralia/Images/")
	...
	viper.SetDefault("radio_notificationSound", "~/.pluralia/audio/notify.mp3")
